...
SQL_REGEX = {
    'root': [
        ...
        (r'[$:?]{?\w+}?', tokens.Name.Placeholder), #Pentaho style placeholder
...
KEYWORDS = {
    ...
    'TRIM': tokens.Name.Builtin,
    'TRUE': tokens.Name.Builtin,
    'TRUNCATE': tokens.Name.Builtin,
...
KEYWORDS_COMMON = {
    ...
    'CASE': tokens.Keyword,
    'WHEN': tokens.Keyword,
    'MIN': tokens.Name.Builtin,
    'MAX': tokens.Name.Builtin,
...
KEYWORDS_PLPGSQL = {
    ...
    'ROW_NUMBER': tokens.Name.Builtin,
...
KEYWORDS_HQL = {
    ...
    'REGEXP_REPLACE': tokens.Name.Builtin,
    'RESIGNAL': tokens.Keyword,
    'RTRIM': tokens.Name.Builtin,
    'SIGN': tokens.Keyword,
